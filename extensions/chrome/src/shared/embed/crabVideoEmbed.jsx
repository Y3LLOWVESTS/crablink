/**
 * RO:WHAT — React scaffold component for extensions/chrome/src/shared/embed/crabVideoEmbed.jsx.
...
export default function CrabVideoEmbed() {
  return (
    <section className="cl-card cl-scaffold-card">
      <p className="cl-eyebrow">Scaffold</p>
      <h1>CrabVideoEmbed</h1>
      <p>extensions/chrome/src/shared/embed/crabVideoEmbed.jsx</p>
    </section>
  );
}
