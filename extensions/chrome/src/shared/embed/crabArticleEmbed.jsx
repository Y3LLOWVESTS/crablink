/**
 * RO:WHAT — React scaffold component for extensions/chrome/src/shared/embed/crabArticleEmbed.jsx.
...
export default function CrabArticleEmbed() {
  return (
    <section className="cl-card cl-scaffold-card">
      <p className="cl-eyebrow">Scaffold</p>
      <h1>CrabArticleEmbed</h1>
      <p>extensions/chrome/src/shared/embed/crabArticleEmbed.jsx</p>
    </section>
  );
}
