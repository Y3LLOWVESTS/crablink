...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::operator_persistence_review::service_node_operator_persistence_decide,
            commands::operator_node::service_node_operator_status,
            commands::operator_reward_binding::service_node_operator_bind_reward_recipient,
            ...
            commands::media::media_get_video_source_preview,
            ...
            commands::media::media_make_export_begin,
            commands::media::media_make_export_append_chunk,
            commands::media::media_make_export_append_audio_chunk,
            commands::media::media_make_export_finish,
            commands::media::media_make_export_status,
            commands::media::media_make_export_clear,
